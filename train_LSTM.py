...
def run_inference(net, loader, criterion, device):
    ...
    with torch.no_grad():
        ...
        for (pc, rgb, bbox_coords, object_scale, s_correction, full_image, sRT) in loader:
            sRT = np.squeeze(sRT)
            ...
            visualize_bboxes(full_image, bbox_coords, out,  rgb,  object_scale, s_correction, sRT)
